...
//    DatabaseMetadataDao dataDao;
    ...
    void setUp() throws SQLException {
        ...
        dao = new ActivityRepository(dataSource);
...
//        Assertions.assertEquals("meccs az iskola tornatermében", activity.getDesc());
...
//        Assertions.assertEquals("egész napos bicótúra", activities.get(2).getDesc());
...
//        Assertions.assertEquals(6, expected.getId());
    ...
    void testSaveActivitywithTrackPointsEverythingIsOK() {
        ...
        Activity expected = dao.findActivityById(6);

        Assertions.assertTrue(activity.getStartTime().equals(expected.getStartTime()));
        Assertions.assertTrue(activity.getDesc().equals(expected.getDesc()));
    ...
    void testSaveActivitywithTrackPointsSomethingIsWrong() {
        ...
        Exception ex1 = Assertions.assertThrows(IllegalArgumentException.class, () -> dao.saveActivity(activity));
        Assertions.assertEquals("Transaction not succeeded!", ex1.getMessage());

        Exception ex2 = Assertions.assertThrows(IllegalArgumentException.class, () -> dao.findActivityById(7));
...
//        Assertions.assertTrue(columnsForImages.contains("content"));
    ...
    void testGetSomeTrackPoints() {
        ...
        List<TrackPoint> expected = dao.findTrackPointsById(6);
