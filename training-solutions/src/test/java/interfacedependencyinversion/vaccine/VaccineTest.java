...
class VaccineTest {
    ...
    void Init() {
        ...
        void testFirstVaccine() {
            ...
            assertEquals("Fehér Ágnes", vaccine.getVaccinationList().get(0).getName());
        ...
        void testSecondVaccine () {
            ...
            assertEquals("Bíró Rita", vaccine.getVaccinationList().get(0).getName());
            assertEquals("Fekete Dávid", vaccine.getVaccinationList().get(1).getName());
